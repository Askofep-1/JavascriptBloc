...
SyntaxElementMorph.prototype.labelPart = function (spec) {
    ...
    if (spec[0] === '%' &&
        ...
        case 'symbol':
            ...
            break;
        case 'c':
            part = new CSlotMorph(true);
            break;
        case 'c0':
            part = new CSlotMorph(false);
            break;
        case 'command slot':
...
BlockLabelMorph.prototype.toCodeString = function ()
{
    return this.text
}
...
BlockMorph.prototype.render = function (ctx)
{
    ...
    if (this.children.length == 1 && !SpriteMorph.prototype.blocks[this.selector])
    {
        this.children[0].bounds = this.bounds
        this.children[0].isStatic = true
    }
...
{
    if (this.children.length == 1 && (this.children[0] instanceof ArgMorph) && !SpriteMorph.prototype.blocks[this.selector])
    {
        this.children[0].bounds = this.bounds
        this.children[0].isStatic = true
        try
...
{
    //this.inset = ((this.inset-1) * this.isIndented)+1 WTF snap AS SLOT!
    if (MorphicPreferences.isFlat) {return; }
...
InputSlotMorph.prototype.messagesMenu = function (searching) {
    ...
    dict['clone start'] = ['__clone__init__ ']
...
ColorSlotMorph.prototype.render = function (ctx)
{
    ...
    this.parent.fixBlockColor = nop
    this.parent.rerender()
    this.parent.mouseClickLeft = this.mouseClickLeft.bind(this)
    //this.parent.render()
    var borderColor;
...
ColorSlotMorph.prototype.toCodeString = function ()
{
...
CommentMorph.prototype.toString = function ()
{
    return "/*" + this.contents.text + "*/";
};
